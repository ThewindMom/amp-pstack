...
export const description =
	'Poteto mode for Amp: explicit Grok 4.6 parent on Amp\'s Grok/ultra prompt and tools, plus pstack routing. Pair with the pstack directory plugin for skills and tools.'
...
export default function (amp: PluginAPI) {
	...
	amp.experimental.registerAgentMode({
		key: 'poteto',
		label: 'poteto',
		description: 'Grok 4.6 with Amp\'s Grok/ultra prompt and tools, then pstack playbooks.',
		color: '#eab308',
