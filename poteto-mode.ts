...
export const description =
	'Poteto mode for Amp: builtin medium parent with Amp tools, plus pstack routing. Higher-cost reasoning stays on delegated judgment seats. Pair with the pstack directory plugin for skills and tools.'
...
export default function (amp: PluginAPI) {
	...
	amp.registerAgentMode({
		...
		label: 'poteto',
		description:
			'Builtin medium with Amp tools, then pstack playbooks. Higher-cost reasoning stays on delegated judgment seats.',
		color: '#eab308',
