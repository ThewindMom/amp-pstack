...
export const description =
	'Poteto mode for Amp: builtin high parent with Amp tools, plus pstack routing. Grok xhigh handles implementation and exploration delegates. Pair with the pstack directory plugin for skills and tools.'
...
export default function (amp: PluginAPI) {
	...
	amp.registerAgentMode({
		...
		label: 'poteto',
		description:
			'Builtin high with Amp tools, then pstack playbooks. Grok xhigh handles implementation and exploration delegates.',
		color: '#eab308',
