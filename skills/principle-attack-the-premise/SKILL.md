...
description: "Only use when named or routed by poteto-mode. Questions a shared premise after two fixes fail the same gate, using an actor census before another fix."
---
