...
- reads of any `SKILL.md` file under project `.agents/skills/`, personal skills, or registered plugin skill paths
- `pstack_start_agent`, `pstack_run_agent`, or `pstack_run_panel` prompts that name a skill path
