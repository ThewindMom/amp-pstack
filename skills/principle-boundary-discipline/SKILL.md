...
description: "Only use when named or routed by poteto-mode. Concentrates guards at system boundaries when wiring validation, error handling, or framework adapters."
---
