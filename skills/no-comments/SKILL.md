...
1. Read `../../agents/comment-sicko.md` and pass its body plus the scope to `pstack_run_agent` with role `comment-reviewer`, local executor. Require report-only behavior.
