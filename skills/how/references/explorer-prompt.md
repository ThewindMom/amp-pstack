...
Start by finding the relevant code. Use `finder` to locate files, symbols, and connected behavior, then use `Read` to understand the actual implementation. Don't guess from names. Read the code.
