...
description: "Only use when named or routed by poteto-mode. Migrates callers and deletes a legacy internal API in one wave when introducing its replacement."
---
