...
description: "Only use when named or routed by poteto-mode. Reproduces debugging symptoms, traces root causes, and fixes them instead of silencing failures with guards."
---
