...
description: "Only use when named or routed by poteto-mode. Generates a project-local verification skill that drives an app like a user when asked for a control skill or when a project lacks scripted UI, CLI, or service proof."
---
