...
description: "Only use when named or routed by poteto-mode. Breaks multi-step work, commits, and PR stacks into ordered units that each end in a verifiable state."
---
